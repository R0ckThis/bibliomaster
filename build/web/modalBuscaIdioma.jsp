...
<div class="modal fade" id="modalBuscaIdioma" tabindex="-1" role="dialog" aria-labelledby="modalExcluirLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h3 class="modal-title" id="modalBuscaLabel">Busca de Idioma</h3>
            </div>
            <div class="modal-body">
                <label>Busca pelo Nome</label>
                <div class="input-group">
                    <input id="criterioIdiomas" type="text" class="form-control">
                    <span class="input-group-btn">
                        <button id="somebutton" type="button" class="btn btn-primary" onclick="consultaEntidade('Idiomas')"><span class="glyphicon glyphicon-search" aria-hidden="true"></span></button>
                    </span>
                </div>
                <div id="Idiomas">
...
<script>
    function selecionarIdioma(campo) {
